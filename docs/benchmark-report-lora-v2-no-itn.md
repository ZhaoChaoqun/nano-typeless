...
|----------|:-------:|:---------:|:-------:|:-------:|:-------:|:---------:|:---:|
| Paraformer Pipeline | 0.1008 | 15/67 | 43 | 57 | 10 | 13.0s | 0.031x |
| Paraformer + Qwen3 Rewrite | 0.1089 | 24/67 | 40 | 55 | 12 | 49.3s | 0.117x |
...
| code_switching | 5 | 0.144 | **0.126** | Paraformer + Q |
| developer_corpus | 8 | **0.135** | 0.158 | Paraformer Pip |
| english_short | 1 | 0.091 | **0.000** | Paraformer + Q |
| long_audio | 2 | 0.066 | **0.054** | Paraformer + Q |
| mid_sentence_pause | 2 | 0.062 | **0.000** | Paraformer + Q |
| mixed_technical | 1 | **0.000** | 0.280 | Paraformer Pip |
| mixed_zh_en | 1 | 0.050 | **0.000** | Paraformer + Q |
| punctuation | 3 | 0.111 | **0.000** | Paraformer + Q |
| real_aishell | 8 | 0.051 | **0.020** | Paraformer + Q |
| real_ascend_codeswitching | 9 | **0.149** | 0.171 | Paraformer Pip |
| real_codeswitching | 8 | **0.096** | 0.152 | Paraformer Pip |
| real_conversational | 3 | **0.074** | 0.102 | Paraformer Pip |
| real_wenetspeech | 10 | **0.092** | 0.111 | Paraformer Pip |
| speech_rate | 2 | **0.132** | 0.292 | Paraformer Pip |
| speech_trailing_silence | 1 | **0.000** | 0.000 | Paraformer Pip |
| technical_numbers | 1 | 0.267 | **0.067** | Paraformer + Q |
| **OVERALL** | 67 | **0.1008** | 0.1089 | **Paraformer Pip** |
...
| mixed_01 | mixed_zh_en | 0.050 | **0** | Paraformer |
| mixed_02 | mixed_technical | **0** | 0.280 | Paraformer |
| en_short_01 | english_short | 0.091 | **0** | Paraformer |
| tech_num_01 | technical_numbers | 0.267 | **0.067** | Paraformer |
| noise_01 | speech_trailing_silence | **0** | **0** | Paraformer |
| dev_git_01 | developer_corpus | 0.150 | **0.100** | Paraformer |
| dev_swift_01 | developer_corpus | 0.045 | **0** | Paraformer |
...
| dev_debug_01 | developer_corpus | **0.050** | 0.150 | Paraformer |
...
| cs_review_01 | code_switching | 0.042 | **0** | Paraformer |
| punct_question_01 | punctuation | **0** | **0** | Paraformer |
| punct_exclaim_01 | punctuation | **0** | **0** | Paraformer |
| punct_list_01 | punctuation | 0.333 | **0** | Paraformer |
| rate_fast_01 | speech_rate | **0.263** | 0.474 | Paraformer |
| rate_slow_01 | speech_rate | **0** | 0.111 | Paraformer |
| long_30s_01 | long_audio | **0.057** | 0.067 | Paraformer |
| long_60s_01 | long_audio | 0.076 | **0.041** | Paraformer |
| pause_mid_01 | mid_sentence_pause | **0** | **0** | Paraformer |
| pause_long_01 | mid_sentence_pause | 0.125 | **0** | Paraformer |
| aishell_test_001 | real_aishell | **0** | **0** | Paraformer |
| aishell_test_002 | real_aishell | 0.143 | **0** | Paraformer |
| aishell_test_003 | real_aishell | **0** | **0** | Paraformer |
| aishell_test_004 | real_aishell | 0.105 | **0** | Paraformer |
...
| aishell_test_008 | real_aishell | 0.083 | **0** | Paraformer |
...
| ascend_cs_006 | real_ascend_codeswitching | 0.316 | **0.298** | Paraformer |
...
| wenet_net_006 | real_wenetspeech | 0.220 | **0.146** | Paraformer |
| wenet_net_007 | real_wenetspeech | 0.111 | **0.056** | Paraformer |
...
| cs_edge_004 | real_codeswitching | **0.068** | 0.591 | Paraformer |
| cs_edge_005 | real_codeswitching | **0.062** | 0.083 | Paraformer |
| cs_edge_006 | real_codeswitching | 0.048 | **0.024** | Paraformer |
| cs_edge_007 | real_codeswitching | **0.091** | 0.212 | Paraformer |
| cs_edge_008 | real_codeswitching | 0.200 | **0.167** | Paraformer |

## 4. 推理速度对比

| Pipeline | 总音频 | 总推理 | RTF | 平均/条 |
|----------|:-----:|:-----:|:---:|:------:|
| Paraformer Pipeline | 421s | 13.0s | 0.031x | 0.19s |
| Paraformer + Qwen3 Rewrite | 421s | 49.3s | 0.117x | 0.74s |
...
| 5 | cs_build_01 | 0.300 | 在macOS上运行swift build。 | 在michael s上运行swift buil。 | 英文词丢失: build,macos |
...
### 5.2 Paraformer + Qwen3 Rewrite（38 条不准确）

| # | ID | CER | 期望文本 | 识别结果 | 错误类型 |
|:-:|-----|:---:|---------|---------|---------|
| 1 | cs_edge_004 | 0.591 | 在GitHub上提了一个issue，关于performance optimiza… | 在 GitHub 上提了一个关于 performance optimizatio… | 英文词丢失: issue, 数字/量词, 幻觉/冗余 |
| 2 | rate_fast_01 | 0.474 | 快速语音识别测试，1、2、3、4、5。 | 快速语音识别测试，一二三四五。 | 数字/量词 |
| 3 | ascend_cs_003 | 0.471 | 深圳啊，或者是上海这种比较大的城市，会有更多opportunity。 | 深圳啊，或者是上海这种表达，城市会有更多机会。 | 英文词丢失: opportunity, 截断 |
| 4 | dev_k8s_01 | 0.382 | Kubernetes的pod状态是CrashLoopBackOff。 | Cubonates 的 pod 状态是 crash, back, back。 | 英文词丢失: kubernetes,crashloopbackoff |
| 5 | cs_error_01 | 0.379 | 这个error是null pointer exception。 | 这个 error 是 no pointer，it se。 | 英文词丢失: exception,null |
| 6 | ascend_cs_006 | 0.298 | 那个玩basketball的，然后我有时候有时候会邀我的friends啊，一起打… | 那个玩玩 basketball，然后我就就是稍微邀我的 France 一起打在就… | 英文词丢失: class,friends, 数字/量词 |
| 7 | mixed_02 | 0.280 | MacBook Pro M3芯片性能提升了百分之40。 | MacBook Pro M，三芯片，性能提升了 40%。 | 数字/量词 |
...
| 10 | ascend_cs_010 | 0.229 | 哦，我我在UG的时候念的是electrical engineering。 | 哦我在 U-G 的时候念的是 electric engineer。 | 英文词丢失: ug,electrical,engineering |
| 11 | dev_rust_01 | 0.217 | 在Rust里面用async await处理并发。 | 在 Rust 里面用 a think wait 处理并发。 | 英文词丢失: async,await |
...
| 17 | cs_edge_008 | 0.167 | CI pipeline跑了30分钟，还没通过unit test。 | CII pipeline 跑了 30 分钟，还没通过 unit。 | 英文词丢失: ci,test, 数字/量词 |
| 18 | wenet_net_002 | 0.154 | 竖锯癌症病成那样，还打着点滴，就更不可能把女警官吊了起来。说来说去，皮特认为还有… | 数据癌症病成那样，还打着点滴就更不可能把女主官吊了起来。说来说去，彼得认为还有其… | 同音字/近音字 |
| 19 | dev_debug_01 | 0.150 | 在第42行设置一个breakpoint。 | 在第四十二行设置一个 break point。 | 英文词丢失: breakpoint, 数字/量词 |
| 20 | ascend_cs_009 | 0.150 | 然后刚忘了讲，你你是念什么major的？ | 然后刚忘了讲一你是念什么 major？ | 标点差异 |
| 21 | wenet_net_006 | 0.146 | 这位叫皮特的FBI探员一上来就一顿物理分析，认为阿曼达不可能吊起比她还重的女警官… | 这位叫 Peter 的 FBI 探员一上来就一顿物理分析，认为阿曼达 不可能吊起… | 数字/量词 |
| 22 | cs_edge_003 | 0.143 | 用Docker Compose部署了3个microservice到staging… | 用 Darker-compose 部署了 3 个 Michao service … | 英文词丢失: docker,microservice, 数字/量词 |
| 23 | conv_zh_001 | 0.120 | 你好，我想要了解一下我的银行账户余额有多少，谢谢。 | 你好，我想了解一下我的银行账户的余额有多少？谢谢。 | 数字/量词, 标点差异 |
| 24 | wenet_net_008 | 0.118 | 把这些劳工抓起来，送到月亮岛上去。 | 把这些劳工抓起来送到月亮搭上去。 | 标点差异 |
| 25 | wenet_net_005 | 0.116 | 还有剧作模式的双线性叙事、结尾神反转等等，也成为了日后电锯惊魂系列在剧作上的结构… | 还有剧作模式的双线性叙事结尾，神反转等等也成为了日后《电锯惊魂》系列在剧作上的结… | 标点差异 |
| 26 | rate_slow_01 | 0.111 | 慢速语音识别测试。 | 慢速语音识别测试 | 标点差异 |
| 27 | ascend_cs_005 | 0.102 | 所以我的我的parents，我的妈妈是chemistry老师，and我的爸爸是h… | 所以我的 parents，我的妈妈是 chemistry 老师，嗯我的爸爸是 h… | 英文词丢失: and |
| 28 | dev_git_01 | 0.100 | 执行git commit，修复登录bug。 | 执行 Git commit 修复登录 BU。 | 英文词丢失: bug, 标点差异 |
| 29 | wenet_net_010 | 0.095 | 媒体也已经报了，然后呃，债主也已经围楼了。 | 媒体也已经报了，然后呃债主也已经为楼了。 | 同音字/近音字 |
| 30 | dev_db_01 | 0.094 | 执行SQL查询SELECT FROM users WHERE id = 1。 | 执行 C QL 查询 select from users where iD 于于… | 英文词丢失: sql |
| 31 | dev_api_01 | 0.087 | 调用RESTful API返回JSON格式数据。 | 调用 RESTful API，返回 JSON 格式数。 | 标点差异 |
| 32 | ascend_cs_008 | 0.087 | 然后呃，我也喜欢play basketball。 | 然后我也喜欢 play basketball。 | 标点差异 |
| 33 | aishell_test_006 | 0.083 | 因此，土地储备至关重要。 | 因此土地储备至关重要。 | 标点差异 |
| 34 | cs_edge_005 | 0.083 | 这个function的return type应该是Optional，而不是for… | 这个 function 的 return tape 应该是 Optional，而… | 英文词丢失: type,unwrap |
| 35 | aishell_test_005 | 0.077 | 标杆房企必然调整市场战略。 | 标杆房企必然调整市场占略。 | 同音字/近音字 |
| 36 | long_30s_01 | 0.067 | 人工智能技术在过去10年中取得了巨大的进步。深度学习算法使得计算机能够处理和理解… | 人工智能技术在过去十年中取得了巨大的进步，深度学习算法使得计算机能够处理和理解自… | 标点差异 |
| 37 | tech_num_01 | 0.067 | 服务器IP地址是192.168.1.100，端口号8080。 | 服务器 IP 地址是 192.168.10.100，端口号 80080。 | 同音字/近音字 |
| 38 | wenet_net_007 | 0.056 | 她已经在商场里开起了小店铺，尽管孤身一人，但与好友见面时还是会爽朗一笑。 | 他已经在商场里开启了小店铺，尽管孤身一人，但与好友见面时还是会爽朗一笑。 | 同音字/近音字 |
...
| code_switching | Paraformer + Qwen3 Rewrite | 0.126 |
| developer_corpus | Paraformer Pipeline | 0.135 |
| english_short | Paraformer + Qwen3 Rewrite | 0.000 |
| long_audio | Paraformer + Qwen3 Rewrite | 0.054 |
| mid_sentence_pause | Paraformer + Qwen3 Rewrite | 0.000 |
| mixed_technical | Paraformer Pipeline | 0.000 |
| mixed_zh_en | Paraformer + Qwen3 Rewrite | 0.000 |
| punctuation | Paraformer + Qwen3 Rewrite | 0.000 |
| real_aishell | Paraformer + Qwen3 Rewrite | 0.020 |
...
| technical_numbers | Paraformer + Qwen3 Rewrite | 0.067 |
